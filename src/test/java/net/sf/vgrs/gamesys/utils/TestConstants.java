...
public class TestConstants {
    ...
    public static final List<Article> ARTICLE_LIST_1 = new ArrayList<>(Arrays.asList(
            new Article("example1.com", "Test", "Test", new Date(), "Test", "Test"),
            new Article("example2.com", "Test", "Test", new Date(), "Test", "Test")
    ));

    public static final List<Article> ARTICLE_LIST_2 = new ArrayList<>(Arrays.asList(
            new Article("example1.com", "Test", "Test", new Date(), "Test", "Test"),
            new Article( "example2.com", "Test", "Test", new Date(), "Test", "Test"),
            new Article( "example3.com", "Test", "Test", new Date(), "Test", "Test")
    ));

    public static final List<Article> ARTICLE_LIST_3 = new ArrayList<>(Arrays.asList(
            new Article("example1.com", "Test", "Test", new Date(), "Test", "Test"),
            new Article("example2.com", "Test", "Test", new Date(), "Test", "Test"),
